...
`
  ...
  document.open()
  $('<html><head>')
  $('<title>' + state.name + "'s Resume <br></title>")
  $('<style>' + styleText + '</style>')
  $('</head><body><div class="resume">')
  $('<h1>' + state.name + '</h1><br>')
  $('<p>' + state.email + '</p><br>')
  $('<p>' + state.phone + '</p><br>')
  $('<p>' + state.address + '</p><br><br><br>')
  $('<div class="line-break"></div>')
  createGroup('ABOUT ME <br><br><br>', state.about)
  createGroup("CAREER OBJECTIVES <br><br><br>", state.career)
  createGroup('EDUCATION <br><br><br>', state.education)
  createGroup('EMPLOYMENT EXPERIENCE <br>', '')
  ...
  createGroup(state.job3.date.start + ' to ' + state.job3.date.end, state.job3.details+'<br><br>')
  createGroup('REFERENCES<br><br><br>', state.references)
  $('</div>')
  $('<div class="generatepdf"> <button class="do_not_show downloadpdf" type="button" onclick="generatePDF()">Download PDF</button></div>')
